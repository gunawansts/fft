...
## How to install (DEFAULT or BASIC USAGE)
	* git clone https://github.com/gunawansts/fft.git
	* cd fft
...
## For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/gunawansts/fft.git)
	* Extract File bot-igeh and enter the folder
	* Right Click on Mouse, Then Select "Git Bash Here" (Make sure you are in the fft folder!!!)
